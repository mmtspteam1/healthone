            ...
            <div className="mx-auto grid max-w-7xl gap-x-8 gap-y-20 px-6 lg:px-8 xl:grid-cols-3">
                <div className="max-w-2xl">
                    ...
                    <p className="mt-6 text-lg leading-8 text-gray-600">
                        &ldquo;Meet our dedicated team of healthcare professionals committed to your well-being. Together, we bring expertise and compassion to every aspect of your health journey.&rdquo;
                    </p>
                </div>
