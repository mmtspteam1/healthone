...
const PatientDetailPage: React.FC<PatientDetailPageProps> = ({ params }) => {
    ...
    return (
        <div className="container mx-auto p-4 flex items-center justify-center min-h-screen">
            <div className="bg-white shadow-lg rounded-lg p-6 w-full max-w-lg">
                ...
                <Image
                    src={patient.url || 'https://imgv3.fotor.com/images/gallery/cartoon-character-generated-by-Fotor-ai-art-creator.jpg'} 
                    alt={patient.Name} 
